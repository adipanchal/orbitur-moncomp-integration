    ...
    <div class="wrap">
      ...
      <form method="post">
        ...
        <table class="form-table">
          <tr><th>Endpoint (no ?wsdl)</th><td><input name="endpoint" value="<?php echo $endpoint; ?>" class="regular-text"></td></tr>
          <tr><th>Test account email</th><td><input name="email" value="<?php echo $email; ?>" class="regular-text"></td></tr>
          <tr><th>Test account password</th><td><input name="password" value="<?php echo $pwd; ?>" class="regular-text"></td></tr>
        </table>
...
function orbitur_ajax_wsdl_test() {
    ...
    if (is_wp_error($res)) {
        ...
        if ($res->get_error_data()) print_r($res->get_error_data());
        wp_die();
    }
    $idSession = $res;
    ...
    if (is_wp_error($raw)) {
        ...
        if ($raw->get_error_data()) print_r($raw->get_error_data());
        wp_die();
    }
    echo "HTTP code: 200\n";
